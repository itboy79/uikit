...
var Icon$X = function (props) {
    ...
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 64 64" }, props),
        React__default['default'].createElement("defs", null,
            React__default['default'].createElement("mask", { id: "mask", x: "3.33", y: "3.33", width: "57.33", height: "60.76", maskUnits: "userSpaceOnUse" },
...
var Icon$J = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 128 128" }, props),
        React__default['default'].createElement("g", null,
            React__default['default'].createElement("path", { d: "M123.35,64.39c-1.78,9.58-6.2,18.52-11.26,26.85-15.46,25.49-44.79,31.31-73.3,32-7.82.18-15.86.14-23.24-2.61C13.76,119.92,2,114.09.21,104.13c-1.58-8.71,5.81-13.4,14.49-27,14.75-23.21,7.22-31.42,21.53-50,5.24-6.79,13-16.88,26.72-20.78,16.39-4.68,34.53,1.35,46.16,12.85,10.14,10,16.44,28.64,14.68,42.38C123.67,62.51,123.52,63.45,123.35,64.39Z", transform: "translate(0 -4.74)", fill: "#f2ce36" }),
            React__default['default'].createElement("path", { d: "M91.69,29.78A66.31,66.31,0,0,0,62.31,40.89c-3,2.07-7,4.43-10,2.24a6,6,0,0,1-1.85-2.45c-2.65-6,1.33-12.68,6.21-16.86A41.11,41.11,0,0,1,90.83,15C105.45,17.83,107.39,27.84,91.69,29.78Z", transform: "translate(0 -4.74)", fill: "#fff", opacity: "0.15" }),
            React__default['default'].createElement("path", { d: "M51.55,118.09a1.3,1.3,0,0,0,.82-2.17c-1.54-3-5.39-3.25-8.54-3.42a46.48,46.48,0,0,1-20.18-6c-5.5-3.11-10.95-7.49-17-7.37a3.26,3.26,0,0,0-1.93.51,3,3,0,0,0-1,1.67c-.76,2.91.59,6.2,2.71,8.41a21.59,21.59,0,0,0,7.66,4.65C26.46,119.41,39.1,121.94,51.55,118.09Z", transform: "translate(0 -4.74)", fill: "#e2b440", opacity: "0.25" }),
            React__default['default'].createElement("path", { d: "M112.32,25.27a3.41,3.41,0,0,0-.69,1.76c-.21,1.77,1.07,4.58,2.05,6.06a4,4,0,0,0,2.77,1.85.6.6,0,0,0,.77-.63c.29-2.4-1.77-4.43-2.58-6.73a9.67,9.67,0,0,0-.69-1.84C113.34,24.73,112.75,24.78,112.32,25.27Z", transform: "translate(0 -4.74)", fill: "#e2b440", opacity: "0.33" }),
            React__default['default'].createElement("path", { d: "M113.66,27.61c.92-1.6,4.87-3.32,6.46-1.51a2.24,2.24,0,0,1,.42.81,3.56,3.56,0,0,1,.3,1.89c-.29,1.48-3.2,1.62-4.34,2.3a1.76,1.76,0,0,1-.75.31,1.45,1.45,0,0,1-1.06-.51C113.33,29.5,113.18,28.44,113.66,27.61Z", transform: "translate(0 -4.74)", fill: "#c67640" }),
            React__default['default'].createElement("g", null,
                React__default['default'].createElement("path", { d: "M109.48,40c-3.84,12.06-3.29,25.32.27,37.62s10,23.7,17.78,34c-2.58-13.86-.11-28,.39-42,.34-9.57-.36-19.58-4.1-28.6-1-2.32-4.37-10.9-7.35-11.16C113,29.58,110.23,37.61,109.48,40Z", transform: "translate(0 -4.74)", fill: "#2a9e3a" }),
                React__default['default'].createElement("path", { d: "M116.45,29.92c-3-1.61-6.43,8.35-7,10-3.84,12.06-3.29,25.32.27,37.62a101.32,101.32,0,0,0,17.61,33.79c-1.7-2.16-1.76-5.06-2.64-7.55-1-2.89-2-5.79-2.94-8.72-4.25-13.71-5.25-28.42-4.35-42.62.24-3.74.66-7.47.73-11.23a40.72,40.72,0,0,0-.28-5.84c-.14-1-.37-4.83-1.32-5.42Z", transform: "translate(0 -4.74)", fill: "#3dad55" })))));
};

var Icon$I = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 128 128" }, props),
        React__default['default'].createElement("defs", null,
            React__default['default'].createElement("linearGradient", { id: "linear-gradient", x1: "64", y1: "128", x2: "64", gradientUnits: "userSpaceOnUse" },
                React__default['default'].createElement("stop", { offset: "0", "stop-color": "#724d3d" }),
                React__default['default'].createElement("stop", { offset: "1", "stop-color": "#876553" }))),
        React__default['default'].createElement("g", null,
            React__default['default'].createElement("circle", { cx: "64", cy: "64", r: "64", fill: "url(#linear-gradient)" }),
            React__default['default'].createElement("path", { d: "M101.09,64.25c-1.11,6-3.87,11.57-7,16.78-9.67,15.92-28,19.56-45.81,20-4.89.11-9.92.09-14.53-1.63C32.6,99,25.26,95.3,24.13,89.08c-1-5.44,3.63-8.37,9.06-16.9C42.41,57.68,37.7,52.54,46.64,41c3.28-4.25,8.14-10.55,16.7-13,10.25-2.92,21.59.85,28.85,8,6.34,6.26,10.28,17.89,9.18,26.48C101.29,63.07,101.2,63.66,101.09,64.25Z", transform: "translate(0 0)", fill: "#f2ce36" }),
            React__default['default'].createElement("path", { d: "M81.31,42.61a41.5,41.5,0,0,0-18.37,7c-1.87,1.29-4.39,2.77-6.27,1.4a3.82,3.82,0,0,1-1.15-1.54c-1.66-3.72.83-7.92,3.88-10.53a25.69,25.69,0,0,1,21.37-5.53C89.91,35.15,91.12,41.4,81.31,42.61Z", transform: "translate(0 0)", fill: "#fff", opacity: "0.15" }),
            React__default['default'].createElement("path", { d: "M56.22,97.8a1,1,0,0,0,.59-.35,1.06,1.06,0,0,0-.08-1c-1-1.87-3.37-2-5.34-2.14a29,29,0,0,1-12.61-3.75c-3.44-1.94-6.84-4.68-10.65-4.6a2,2,0,0,0-1.2.32,1.88,1.88,0,0,0-.6,1A5.84,5.84,0,0,0,28,92.57a13.38,13.38,0,0,0,4.78,2.91C40.54,98.63,48.44,100.21,56.22,97.8Z", transform: "translate(0 0)", fill: "#e2b440", opacity: "0.25" }),
            React__default['default'].createElement("path", { d: "M94.2,39.79a2.18,2.18,0,0,0-.43,1.1,7.14,7.14,0,0,0,1.28,3.79,2.45,2.45,0,0,0,1.73,1.16.47.47,0,0,0,.33-.06.51.51,0,0,0,.15-.34c.19-1.49-1.1-2.77-1.61-4.2a6.33,6.33,0,0,0-.43-1.15C94.83,39.46,94.47,39.49,94.2,39.79Z", transform: "translate(0 0)", fill: "#e2b440", opacity: "0.33" }),
            React__default['default'].createElement("path", { d: "M95,41.25c.57-1,3-2.07,4-.94a1.89,1.89,0,0,1,.26.51A2.41,2.41,0,0,1,99.53,42c-.19.92-2,1-2.72,1.44a1,1,0,0,1-.47.19.89.89,0,0,1-.66-.32C94.83,42.44,94.74,41.78,95,41.25Z", transform: "translate(0 0)", fill: "#c67640" }),
            React__default['default'].createElement("g", null,
                React__default['default'].createElement("path", { d: "M92.43,49c-2.4,7.53-2.06,15.82.17,23.51a66.72,66.72,0,0,0,11.11,21.27c-1.62-8.66-.07-17.48.24-26.23.22-6-.22-12.24-2.56-17.88-.6-1.45-2.73-6.81-4.6-7C94.63,42.49,92.89,47.51,92.43,49Z", transform: "translate(0 0)", fill: "#2a9e3a" }),
                React__default['default'].createElement("path", { d: "M96.78,42.7c-1.9-1-4,5.22-4.35,6.28-2.4,7.53-2.06,15.82.17,23.51a63.11,63.11,0,0,0,11,21.12c-1.06-1.35-1.1-3.17-1.65-4.72-.64-1.81-1.27-3.62-1.84-5.45A74.5,74.5,0,0,1,97.39,56.8c.15-2.34.42-4.67.46-7a24.73,24.73,0,0,0-.18-3.65c-.08-.64-.22-3-.82-3.39Z", transform: "translate(0 0)", fill: "#3dad55" })))));
};
...
styled.keyframes(templateObject_1$j || (templateObject_1$j = __makeTemplateObject(["\n  from {\n    transform: rotate(0deg);\n  }\n  to {\n    transform: rotate(360deg);\n  }\n"], ["\n  from {\n    transform: rotate(0deg);\n  }\n  to {\n    transform: rotate(360deg);\n  }\n"])));
...
var FloatingMangoIcon = styled__default['default'](Icon$s)(templateObject_4$3 || (templateObject_4$3 = __makeTemplateObject(["\n  animation: ", " 2s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  animation: ", " 2s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"])), float);
var Spinner = function (_a) {
    var _b = _a.size, size = _b === void 0 ? 72 : _b;
    return (React__default['default'].createElement(Container$3, null,
        React__default['default'].createElement(FloatingMangoIcon, { width: size + "px" })));
};
